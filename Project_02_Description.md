...
| `data/plate_with_hole_mesh.npz` | Pre-generated fallback mesh for hole problem | See "Fallback Mesh" below                     |
...
| `.gitignore`,                   | Git ignore patterns                          | Provided — copy as-is                         |
| `.dockerignore`                 | Docker ignore patterns                       | Provided — copy as-is                         |
| `AI_Usage_Summary_Example.md`   | Example of what a good AI summary looks like | Reference only — do not submit this           |
